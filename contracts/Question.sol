...
contract contractB {
    ETLToken tokenContract = ETLToken(0x4dD73b957e517DcCadBBCEa58282763Ab1d2B27C);
...
contract Profile {
    ETLToken public tokenContract = ETLToken(0x4dD73b957e517DcCadBBCEa58282763Ab1d2B27C);
    uint public token;
